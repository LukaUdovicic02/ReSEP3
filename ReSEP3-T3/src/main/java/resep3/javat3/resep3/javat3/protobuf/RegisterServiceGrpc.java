...
public final class RegisterServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<resep3.javat3.protobuf.RegisterRequest,
      resep3.javat3.protobuf.RegisterResponse> getRegisterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "register",
      requestType = resep3.javat3.protobuf.RegisterRequest.class,
      responseType = resep3.javat3.protobuf.RegisterResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<resep3.javat3.protobuf.RegisterRequest,
      resep3.javat3.protobuf.RegisterResponse> getRegisterMethod() {
    io.grpc.MethodDescriptor<resep3.javat3.protobuf.RegisterRequest, resep3.javat3.protobuf.RegisterResponse> getRegisterMethod;
      ...
      synchronized (RegisterServiceGrpc.class) {
        if ((getRegisterMethod = RegisterServiceGrpc.getRegisterMethod) == null) {
          RegisterServiceGrpc.getRegisterMethod = getRegisterMethod =
              io.grpc.MethodDescriptor.<resep3.javat3.protobuf.RegisterRequest, resep3.javat3.protobuf.RegisterResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "register"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  resep3.javat3.protobuf.RegisterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  resep3.javat3.protobuf.RegisterResponse.getDefaultInstance()))
  ...
  public static abstract class RegisterServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void register(resep3.javat3.protobuf.RegisterRequest request,
        io.grpc.stub.StreamObserver<resep3.javat3.protobuf.RegisterResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                resep3.javat3.protobuf.RegisterRequest,
                resep3.javat3.protobuf.RegisterResponse>(
  ...
  public static final class RegisterServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RegisterServiceBlockingStub> {
    ...
    /**
     */
    public resep3.javat3.protobuf.RegisterResponse register(resep3.javat3.protobuf.RegisterRequest request) {
  ...
  public static final class RegisterServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RegisterServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<resep3.javat3.protobuf.RegisterResponse> register(
        resep3.javat3.protobuf.RegisterRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER:
          serviceImpl.register((resep3.javat3.protobuf.RegisterRequest) request,
              (io.grpc.stub.StreamObserver<resep3.javat3.protobuf.RegisterResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class RegisterServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return resep3.javat3.protobuf.Register.getDescriptor();
    }
