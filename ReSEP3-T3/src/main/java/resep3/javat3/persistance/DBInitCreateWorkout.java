...
public class DBInitCreateWorkout {
    ...
    public static void main(String[] args) throws SQLException {
     ...
     //   deleteWorkout(2);
        updateWorkoutPlan("test" , 55, 1, "chest", 8);

    }

    public static void updateWorkoutPlan(String WPname,  int timegoal , int userid, String type , int wpid) {
        ...
        try {
            ...
            PreparedStatement statement = connection.prepareStatement("UPDATE WorkoutPlan SET WPname= '" + WPname +
                    "', timegoal = '" + timegoal + "', UserID  = '" + userid + "'," +
                    " type = '" + type + "' WHERE WPID = " + wpid);
    ...
    // works
    private static void updateWorkout(int wpid, String WPname, int timegoal, String type , int userid ) {
        try (Connection connection = DriverManager.getConnection("jdbc:sqlite:WorkoutDB.db");
             Statement statement = connection.createStatement()) {
